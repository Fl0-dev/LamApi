...
class ApplicantLamatchProfileFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $applicantLamatchProfile->setDesiredWorkforce((new Workforce(Workforce::LEVEL_2, '10 à 19 salariés', 2))->getId());
        ...
        $applicantLamatchProfile->setDesiredWorkforce((new Workforce(Workforce::LEVEL_3, '20 à 49 salariés', 3))->getId());
        $applicantLamatchProfile->addTool($this->getReference(ToolFixtures::TOOL_REFERENCE_1));
        ...
        $applicantLamatchProfile->setDesiredWorkforce((new Workforce(Workforce::LEVEL_4, '50 à 99 salariés', 4))->getId());
        $applicantLamatchProfile->addTool($this->getReference(ToolFixtures::TOOL_REFERENCE_1));
        ...
        $applicantLamatchProfile->setDesiredWorkforce((new Workforce(Workforce::LEVEL_1, '1 à 9 salariés', 1))->getId());
        $applicantLamatchProfile->addTool($this->getReference(ToolFixtures::TOOL_REFERENCE_5));
        $applicantLamatchProfile->addTool($this->getReference(ToolFixtures::TOOL_REFERENCE_7));
