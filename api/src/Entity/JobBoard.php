...
#[ApiResource(operations: [new Get(uriTemplate: '/job-boards/{id}/offers', normalizationContext: ['groups' => ['getJobBoardOffers']], formats: ['json' => ['application/json']]), new Post(), new GetCollection()])]
