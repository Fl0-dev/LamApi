...
class Offer
{
    ...
    #[Groups([self::OPERATION_NAME_GET_OFFER_DETAILS, CompanyGroup::OPERATION_NAME_GET_OFFERS_BY_COMPANY_GROUP_ID, JobBoard::OPERATION_NAME_GET_JOB_BOARD_OFFERS])]
    private $provided;

    #[ORM\Column(type: 'string', length: 255)]
    #[
        Groups([self::OPERATION_NAME_GET_OFFER_DETAILS, self::OPERATION_NAME_GET_OFFER_TEASERS, CompanyGroup::OPERATION_NAME_GET_OFFERS_BY_COMPANY_GROUP_ID, JobBoard::OPERATION_NAME_GET_JOB_BOARD_OFFERS, self::OPERATION_NAME_POST_OFFER]),
        Length(
            min: 3,
            max: 255,
    ...
    #[ORM\Column(type: 'boolean')]
    #[Groups([self::OPERATION_NAME_GET_OFFER_DETAILS, CompanyGroup::OPERATION_NAME_GET_OFFERS_BY_COMPANY_GROUP_ID, JobBoard::OPERATION_NAME_GET_JOB_BOARD_OFFERS, self::OPERATION_NAME_POST_OFFER])]
    ...
    #[Groups([self::OPERATION_NAME_GET_OFFER_APPLICATIONS, JobBoard::OPERATION_NAME_GET_JOB_BOARD_OFFERS])]
    #[ORM\JoinColumn(nullable: true)]
    ...
    #[ORM\JoinColumn(nullable: false)]
    #[Groups([self::OPERATION_NAME_GET_OFFER_DETAILS, self::OPERATION_NAME_GET_OFFER_TEASERS, JobBoard::OPERATION_NAME_GET_JOB_BOARD_OFFERS, self::OPERATION_NAME_POST_OFFER])]
