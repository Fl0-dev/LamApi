...
class ApplicantCv
{
    ...
    #[Groups([Offer::OPERATION_NAME_GET_OFFER_APPLICATIONS, CompanyGroup::OPERATION_NAME_GET_APPLICATIONS_BY_COMPANY_GROUP_ID, Application::OPERATION_NAME__POST_APPLICATION_BY_OFFER_ID])]
    private $filePath;
